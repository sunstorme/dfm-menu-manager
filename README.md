...
```bash
# 克隆项目
git clone https://github.com/yourusername/dfm-menu-manager.git
cd dfm-menu-manager
...
- 项目主页: [https://github.com/yourusername/dfm-menu-manager](https://github.com/yourusername/dfm-menu-manager)
- 问题反馈: [Issues](https://github.com/yourusername/dfm-menu-manager/issues)
